export const insults = [
  ...
  "So, you're a half (insert), was your mother a spider or is your ass naturally that huge!",
  ...
  "What smells worse than a dead goblin? A live one!",
  "Green skin was sooo last season!",
  "You spell like a barbarian! Spell! I said spell! (against a caster/magic user)",
  "Your mother takes up more tiles than a gelatinous cube!",
  ...
  "Biggest Kobold I ever saw(to any reptilian race other than kobold).",
  "Damn, you're ugly enough to collect warlock autographs(likening them to a fiend or cthulu).",
  "Ugh what the hell is that all over your face? Oh.. that's just your face.",
  "Charisma was OBVIOUSLY your dump stat!",
  "You have the dexterity of a rhino! And only half the looks!",
  "You are going to make an excellent belt! (any creature with hide or scales)",
  "You're so ugly when you take a bath the water makes a reflex save! With advantage! Who are we kidding, you don't bathe!",
  "Alright guys pour on the fire damage! Wait, what? Oh no, nevermind he's not an actual troll.",
  "Oh god the smell! Elderberries would be an improvement!",
  "I don't know whether to charm person or beast!",
  "You're the reason baby gnomes cry!",
  "If you had any more teeth... you'd have one!",
  "No loot is worth having to look at you!",
  "Your challenge rating has to be in the negatives.",
  "You kleptomaniacal, self righteous, oversized gila monster!(to a dragon)",
  "You orcs are so poor your shields are on layaway!",
  "Your fighting stance looks like an unfolded lawn chair!",
  "You are so damn clumsy your 0 level spells are called willtrips!",
  "Your lack of personal hygene doesn't require a perception check!",
  "You are irrelevant to the main plotline!",
  "Do you even have a name? You are so dead.",
  "Do you even have a last name? Hahaha didn't think so!",
  "You are a one demensional character that lacks even a generic backstory!",
  ...
  "You aren't being the person Mr. Rodgers thought you could be!",
  "You monolog like a subpar 60's batman villan!",
  "Your doomsday device looks like it was built by ikea!",
  "You're a disapointment to your ancestors!",
  "You swing like a halfling!",
  "If I knew darkvision ment I still had to look at your ugly mug at night I'd have rolled human!",
  "I've seen more threatening geckos.",
  "Why don't you summon yourself some real friends? (Magic User)",
  "Wow... You're amazing! Wait... No, what's the opposite of amazing? Oh, yeah, shit! You're shit at this!",
...
export const getInsult = () => {
    ...
    return insults.splice(Math.floor(Math.random()*insults.length), 1);
